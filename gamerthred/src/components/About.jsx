  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#050D2B] via-[#0B132F] to-[#060A1B] text-white px-4 py-16 md:px-24 font-sans">
      ...
      <div className="flex flex-col md:flex-row gap-8 overflow-x-auto md:overflow-visible pb-4">
        ...
        <div className="min-w-[300px] md:flex-1 bg-white bg-opacity-10 p-6 rounded-2xl shadow-lg backdrop-blur-md transition hover:scale-[1.01] duration-300">
          <h2 className="text-2xl font-semibold mb-4 text-purple-400">
            About GamerThred
          </h2>
          <p className="text-base text-gray-200 leading-relaxed">
            Welcome to{" "}
            <span className="font-bold text-purple-300">GamerThred</span>, where
            gamers earn rewards for playing their favorite games! We believe
            every player should be rewarded. Our platform lets you complete fun,
            game-specific missions to earn cool stuff like T-shirts and gaming
            gear.
          </p>
        </div>
        ...
        <div className="min-w-[300px] md:flex-1 bg-white bg-opacity-10 p-6 rounded-2xl shadow-lg backdrop-blur-md transition hover:scale-[1.01] duration-300">
          ...
          <ul className="list-disc text-base text-gray-200 pl-5 space-y-2 mb-6">
            ...
            <li>
              <strong>Real Prizes:</strong> Get gaming gear, apparel, and more.
            </li>
            <li>
